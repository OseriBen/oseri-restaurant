  ...
  return (
    ...
    >
      <nav className="flex justify-center px-4 md:px-8 py-2">
        <motion.div
          className={`flex items-center justify-between w-full max-w-6xl px-6 py-3 rounded-full backdrop-blur-md acrylic transition-colors duration-300 ${
            scrolled
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            exit={{ y: -20, opacity: 0 }}
            transition={{ duration: 0.3 }}
            className="absolute top-16 left-0 w-full px-4 md:hidden z-50"
          >
